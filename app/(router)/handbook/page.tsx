        ...
        <div className='custom-container-child py-6'>
            <div className='flex flex-col gap-4'>
                ...
                <div className='grid grid-cols-2 gap-8'>
                    {
                        dataListHandbookMom.map((item) => (
                            <div key={item.id} className='flex flex-col justify-center items-center gap-2 bg-rose-50 shadow-md rounded-xl px-6 py-8 cursor-pointer'>
                                ...
                                <div className='3xl:text-lg text-base font-semibold line-clamp-2'>
                                    {item.name}
                                </div>
                            </div>
                        ))
